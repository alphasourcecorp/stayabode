...
public class DeliveryPartnerDetailFragment extends Fragment {
    ...
    TextView responseTimeHeader;
    TextView deliveryPersonCount;
    TextView deliveryPersonHeader;
    TextView weightCount;
    TextView weightHeader;
    TextView deliveryPartnerDetailheader;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_delivery_partner_profile,container,false);
...
//        });
        ...
        pagetitle.setText("Delivery Partner Profile");
        ...
        deliveryPartnerName = rootView.findViewById(R.id.deliveryPartnerName);
        city = rootView.findViewById(R.id.city);
        status = rootView.findViewById(R.id.status);
        quickStatsHeader = rootView.findViewById(R.id.quickStatsHeader);
        responseValue = rootView.findViewById(R.id.responseValue);
        responseTimeHeader = rootView.findViewById(R.id.responseTimeHeader);
        deliveryPersonCount = rootView.findViewById(R.id.deliveryPersonCount);
        deliveryPersonHeader = rootView.findViewById(R.id.deliveryPersonHeader);
        deliveryPartnerDetailheader = rootView.findViewById(R.id.deliveryPartnerDetailheader);
        weightCount = rootView.findViewById(R.id.weightCount);
       ...
       // phoneValue = rootView.findViewById(R.id.phoneValue);
        ...
        deliveryPartnerName.setTypeface(fontBold);
        city.setTypeface(fontRegular);
        status.setTypeface(fontRegular);
        quickStatsHeader.setTypeface(fontBold);
        responseTimeHeader.setTypeface(fontRegular);
        responseValue.setTypeface(fontBold);
        deliveryPersonCount.setTypeface(fontBold);
        deliveryPersonHeader.setTypeface(fontRegular);
        weightCount.setTypeface(fontBold);
...
//        emailValue.setTypeface(fontRegular);
        ...
        deliveryPartnerDetailheader.setTypeface(fontBold);
    ...
    public void deliveryPartnerProfile()
    {
        bodyLayout.setVisibility(View.GONE);
        progressBar.setVisibility(View.VISIBLE);
        noInternetLayout.setVisibility(View.GONE);
        //recyclerView.setVisibility(View.GONE);
        String url = APIBaseURL.deliveryPartnerProfileID + getArguments().getString("Id");
        ...
        CustomVolleyRequest stringRequest = new CustomVolleyRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONObject deliveryPartnerObject = dataObject.getJSONObject("deliveryPartner");

                    deliveryPartnerName.setText(deliveryPartnerObject.optString("name"));
                    Glide.with(getContext()).load(deliveryPartnerObject.optString("uploadLogo").replaceAll(" ","%20")).placeholder(R.drawable.foodi_logo_left_image).into(profileImage);
                    city.setText(deliveryPartnerObject.optString("location"));

                    locationValue.setText(deliveryPartnerObject.optString("location"));
                    addressLine1Value.setText(deliveryPartnerObject.optString("addressLine1"));
                    addressLine2Value.setText(deliveryPartnerObject.optString("addressLine2"));
                    addressLine3Value.setText(deliveryPartnerObject.optString("addressLine2"));
                    pinCodeValue.setText(deliveryPartnerObject.optString("pinCode"));
                    stateValue.setText(deliveryPartnerObject.optString("state"));
                    countryValue.setText(deliveryPartnerObject.optString("country"));
                    //phoneValue.setText(deliveryPartnerObject.optString("contactNumber"));
                    //emailValue.setText(deliveryPartnerObject.optString("email"));
                    responseValue.setText(deliveryPartnerObject.optString("responseTime"));
                    deliveryPersonCount.setText(deliveryPartnerObject.optString("numberOfDeliveryPersons"));
                    weightCount.setText(deliveryPartnerObject.optString("maxWeight")+" Kg");

                    if(deliveryPartnerObject.optString("isActive").equalsIgnoreCase("active"))
                    {
                    ...
                    JSONArray franchiseMappedArray = dataObject.getJSONArray("franchise");

                    for (int i=0;i < franchiseMappedArray.length();i++)
                    {
                        JSONObject franchiseMappedObject = franchiseMappedArray.getJSONObject(i);
                        Franchise franchise = new Franchise();
                        franchise.setLocation(franchiseMappedObject.optString("franchiseLocation"));
                        franchise.setName(franchiseMappedObject.optString("franchiseName"));
                        franchise.setImage(franchiseMappedObject.optString("franchiseLogo"));
                        franchiseList.add(franchise);
                    }
                    ...
                    JSONArray contactArray = deliveryPartnerObject.getJSONArray("contactNumber");
                    ...
                    JSONArray emailArray = deliveryPartnerObject.getJSONArray("email");
...
//                    text.setText("Delivery partner details not available!");
...
//                }
        ...
        ApplicationController.getInstance().addToRequestQueue(stringRequest,"detail_taq_delivery_partner");
    }
}

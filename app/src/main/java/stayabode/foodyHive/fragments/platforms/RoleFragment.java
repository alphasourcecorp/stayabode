...
public class RoleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_role, container, false);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        Role role = new Role();
                        role.setRoleName(roleObject.optString("name"));
                        // role.setCreatedDate("Created date - 12 June 2019");
                        ...
                        try {
                            ...
                            Date createddate = sdf.parse(roleObject.optString("createdDate"));

                            role.setCreatedDate("Created date - "+createdDate.format(createddate));

                        } catch (ParseException e) {
                            e.printStackTrace();
                        }
                        role.setActiveStatus(roleObject.optString("status"));
                        objectList.add(role);
                        roleList.add(role);
                    }

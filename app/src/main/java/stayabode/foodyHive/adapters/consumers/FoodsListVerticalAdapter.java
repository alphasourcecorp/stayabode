...
public class FoodsListVerticalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FoodsListVerticalAdapter(Context context, List<FoodItem> foodItemList, Typeface poppinsLight, Typeface poppinsSemiBold, Typeface RobotoRegular, Typeface RobotoBold) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.populars_food_views_list_item, parent, false);

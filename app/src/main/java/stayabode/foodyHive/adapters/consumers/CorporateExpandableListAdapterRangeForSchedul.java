...
public class CorporateExpandableListAdapterRangeForSchedul extends BaseExpandableListAdapter {
    ...
    public CorporateExpandableListAdapterRangeForSchedul(Context context, ExpandableListView ex, List<String> listDataHeader, HashMap<String, List<String>> listChildData) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.corporate_expand_list_group_new_for_schedule, null);
        }

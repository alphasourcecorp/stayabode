...
public class FoodsListVerticalAdapterAdminReject extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FoodsListVerticalAdapterAdminReject(Context context, List<FoodItem> foodItemList, Typeface poppinsLight, Typeface poppinsSemiBold, Typeface RobotoRegular, Typeface RobotoBold) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.corporate_admin_reject_list_item, parent, false);

...
public class CorporateExpandableListAdapterRange extends BaseExpandableListAdapter {
    ...
    public CorporateExpandableListAdapterRange(Context context, ExpandableListView ex, List<String> listDataHeader, HashMap<String, List<String>> listChildData) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.corporate_expand_list_group_new, null);
        }
...
//        }
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.range_corporate_expand_list_row_new, null);
        }
...
if(!(jsonObject.getString("dishImage").equals("null")))
{
    Glide.with(_context).load(jsonObject.getString("dishImage")).into(dish_img);
            ...
            if(jsonObject.getString("saleAmount").equals("0"))
            {
                ...
                price_id.setText("₹ "+" TBD ");
            }else
            {
                price_id.setText("₹ "+jsonObject.getString("saleAmount")+"/-");
            }

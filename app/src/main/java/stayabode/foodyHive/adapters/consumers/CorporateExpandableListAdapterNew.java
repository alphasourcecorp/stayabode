...
public class CorporateExpandableListAdapterNew extends BaseExpandableListAdapter {
    ...
    public CorporateExpandableListAdapterNew(Context context,ExpandableListView ex,  List<String> listDataHeader, HashMap<String, List<String>> listChildData) {
...
//        }
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.corporate_expand_list_row_new, null);
        }

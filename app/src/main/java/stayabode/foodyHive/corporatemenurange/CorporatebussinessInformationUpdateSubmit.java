...
public class CorporatebussinessInformationUpdateSubmit extends AppCompatActivity {
 ...
 ListView navLV;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
     ...
     //   GetscheduleCount();
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(CorporatebussinessInformationUpdateSubmit.this, R.layout.support_simple_spinner_dropdown_item, spinnerList2);
        ...
        ArrayAdapter<String> arrayAdapter2 = new ArrayAdapter<String>(CorporatebussinessInformationUpdateSubmit.this, R.layout.support_simple_spinner_dropdown_item, spinnerList);
        arrayAdapter.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
...
//        postal_id.setText(postalcode_share);
        ...
        order_subscription_id.setText("Update Order Request");
        textView26.setText("Update Order Request");
        ...
        order_subscription_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validatenew(addressline1_str, addressline2_str, city_id_str,postal_id_str,state_id_str,country_id_str)) {
                    pDialog = ProgressDialog.show(CorporatebussinessInformationUpdateSubmit.this, "", "Please wait...", true,false);
                    ...
                    try {
                        ...
                        inputObject.put("subscriptionDate",subscriptionDate);
                        inputObject.put("schedullingInfo",Globaluse.scheduleList);
...
//                        }else
//                        {
//                            inputObject.put("isActive",false);
//                        }
//                        if(isDeleted.equalsIgnoreCase("true"))
//                        {
//                            inputObject.put("isDeleted",true);
//                        }else
//                        {
//                            inputObject.put("isDeleted",false);
//                        }
//
//                        inputObject.put("partitionKey",partitionKey);
//                        inputObject.put("rowKey",rowKey);
//                        inputObject.put("timestamp",timestamp);
//                        inputObject.put("eTag",eTag);
//                        inputObject.put("emailFlag",emailFlag);
                    ...
                    String URL = APIBaseURL.BASEURLLINK_B2B_SB_UPDATE;
                               ...
                               // Toast.makeText(CorporatebussinessInformation.this, response.optString("errorMessage"), Toast.LENGTH_SHORT).show();
                                ...
                                try {
                                    ...
                                    if(jsonObject.getString("isSuccess").equals("true"))
                                    {
                                       // pDialog.dismiss();
                                        corporateshared("no");
                                        final Dialog dialog = new Dialog(CorporatebussinessInformationUpdateSubmit.this);
                                        ...
                                        textView16.setText("Update successfully");
                                        ...
                                        subscribe_id.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                dialog.cancel();
                                                finishAffinity();
                                                Intent intent = new Intent(CorporatebussinessInformationUpdateSubmit.this, CorporateMenuWithNavigatioin.class);
                                                startActivity(intent);
...
//        total_id.setText(""+full_totalvalue);
       ...
       CustomAdapter adapter = new CustomAdapter(this,  Globaluse.corporatedishlistnew);
        ...
        horizontalAdapter2=new CustomAdapterRecycle(Globaluse.scheduleList);
        LinearLayoutManager horizontalLayoutManagaer2 = new LinearLayoutManager(CorporatebussinessInformationUpdateSubmit.this, LinearLayoutManager.HORIZONTAL, false);
        ...
        for(int k=0;k<Globaluse.scheduleList.length();k++)
        {
            ...
            try {
                ...
                if(isWekely)
                {
                    //Toast.makeText(CorporatebussinessInformationUpdateSubmit.this, "Only Weekly Selection", Toast.LENGTH_SHORT).show();
                    alltotal1=(selectmeal * 1);
                }
                else
                {
                    //Toast.makeText(CorporatebussinessInformationUpdateSubmit.this, "Day selection", Toast.LENGTH_SHORT).show();
...
//                                double selectmeal=(dishtotal * totalmeal);
//                                //Log.i(TAG, "dishTotal ( * ) totalmeal" + selectmeal);
//                                long numberOfDays=(((ChronoUnit.DAYS.between(start, end)))-(exclusionDates_jsonarray.length()));
//                                // Log.i(TAG, "numberOfDays : start date & end date "+""+ChronoUnit.DAYS.between(start, end)+ " - "+"exclusionDates length : "+exclusionDates_jsonarray.length()+" = "+numberOfDays);
//                                double alltotal1=(selectmeal * numberOfDays);
//                                //Log.i(TAG, "all total" + alltotal1);
//
...
//                                total_id.setText(""+sub_totalvalue);
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof AuthFailureError) {
                    ...
                    Toast.makeText(CorporatebussinessInformationUpdateSubmit.this, "Cannot connect to Internet...Please check your connection!", Toast.LENGTH_SHORT).show();
                }
            }
        }, CorporatebussinessInformationUpdateSubmit.this){    //this is the part, that adds the header to the request
            @Override
            public Map<String, String> getHeaders() {
                SharedPreferences sh = getSharedPreferences("corporateLogin", MODE_APPEND);
                String token = sh.getString("token", "");
...
//            String part3 = parts[2];
                ...
                String[] separated = (dataSet.getJSONObject(listPosition).getString("startDate").split("T"));
...
//            String part31= parts1[2];
                ...
                String[] separated1 = (dataSet.getJSONObject(listPosition).getString("endDate").split("T"));
                String string1 = separated1[0];
